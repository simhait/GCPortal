/*
  # Update meal counts by eligibility for all dates

  1. Changes
    - Update meal counts by eligibility for all dates and schools
    - Calculate meal counts based on eligibility percentages
    - Ensure counts add up to totals
    - Add random variation to make data more realistic

  2. Data Quality
    - Maintain proper ratios between free, reduced, and paid meals
    - Ensure totals match existing breakfast and lunch counts
    - Add realistic daily variations while maintaining overall patterns
