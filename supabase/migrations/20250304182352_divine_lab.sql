/*
  # Special Diets Management Schema

  1. New Tables
    - `diet_profiles`
      - Core diet profile information
      - Tracks diet types and requirements
    - `diet_restrictions`
      - Individual restrictions within a diet profile
      - Can be allergies, religious restrictions, etc.
    - `student_diets`
      - Links students to diet profiles
      - Tracks active status and notes
    - `diet_categories`
      - Categories for restrictions (allergy, religious, etc.)
    - `diet_ingredients`
      - Common ingredients to avoid
      - Used for meal planning and compliance

  2. Security
    - Enable RLS on all tables
    - Policies for district-based access control
    - Director and manager role permissions

  3. Indexes
    - Optimized for school-based queries
    - Fast student lookup
    - Efficient meal planning checks
*/
